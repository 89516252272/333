...
public class logWindow extends Frame{   /*Создаем подкласс logWindow  класса Frame*/
    ...
    {
        super ("Закамна");    /*Вызываем конструктор суперкласса и передаем ему параметр, в данном случае имя программы*/
        setSize (200,200);  /*Метод суперкласса для установкиразмеров окна, в пикселях*/
        //Создаем объекты
        Button myButton = new Button ("Закамна");  /*Создаем кнопку и надпись на  ней*/
        final Label myLabel = new Label ("Я люблю Закамну"); // Создаем текстовое поле и надпись в нем*/
        ...
        myButton.addActionListener (new ActionListener () {    /*Для кнопки выбираем событие слушателя, и создаем новое событие в скобках.*/
            public void actionPerformed (ActionEvent e) {
                myLabel.setText ("Закамна"); /*Выполняется действие, т.е. при нажатии на кнопку в поле выводится сообщение  «Мониторинг» */
            }
        });
    }
